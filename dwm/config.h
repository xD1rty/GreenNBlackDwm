...
static const unsigned int gappx     = 10;       /* snap pixel */
static const int showbar            = 1;        /* 0 means no bar */
static const int topbar             = 1;        /* 0 means bottom bar */
static const char *fonts[]          = { "Iosevka Nerd Font Mono:style=Medium:size=11" };
static const char dmenufont[]       = "Iosevka Nerd Font Mono:style=Medium:size=15";
static const char black[]       = "#000000";
static const char green[]       = "#00ff00";
static const char grey[]		= "#808080";
static const char *colors[][3]      = {
	/*              текст       фон        рамка    */
	[SchemeNorm] = { green, 	black,  	grey },
	[SchemeSel]  = { black, 	green, 		green  },
};

/* tagging */
static const char *tags[] = { "term", "code", "messages", "games", "mus", "file", "set", "da hz lol))", "browser" };
